...
class LongClipEvalPipeline:
    """
    使用 LongCLIPEvaluator 对 image + caption（长文本）进行图文对齐打分。
    """
    ...
    def __init__(
        ...
        *,
        ...
        file_name_prefix: str = "imgtext_eval_longclip",
        ...
        self.longclip_evaluator = ImageLongCLIPEvaluator(model_name=model_name)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Evaluate image-text alignment with LongCLIP")

    parser.add_argument("--input_file", default="./dataflow/example/test_image_eval/test_image_eval.jsonl")
    parser.add_argument("--output_file", default="./cache_eval/longclip_eval_result.jsonl")
    parser.add_argument("--cache_path", default="./cache_eval")
    parser.add_argument("--file_name_prefix", default="imgtext_eval_longclip")
    parser.add_argument("--cache_type", default="jsonl")
    parser.add_argument("--model_name", default="BeichenZhang/LongCLIP-L-336px")
    parser.add_argument("--image_key", default="image")
    parser.add_argument("--caption_key", default="caption")
    parser.add_argument("--output_key", default="longclip_score")
    ...
    print(f"\nLongCLIP 评估结果已保存到: {args.output_file}")
